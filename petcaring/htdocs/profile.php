    ...
    <div class="row">
      ...
      <div class="row">
            <div class="col s4">
              ...
              <input class="w3-input w3-border active" type="text" name="address" disabled value="<?php echo $_SESSION[address]?>"/>
            </div>

            <div class="col s4">
              <p><label><i class=""></i> Postal Code:</label></p>
              <input class="w3-input w3-border active" type="text" name="postal_code" disabled value="<?php echo $_SESSION[postal_code]?>"/>
            </div>
      </div>
