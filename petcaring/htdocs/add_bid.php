...
<body>
  ...
  <h3 class="light-blue-text text-lighten-1 center header-padding">Add a bid</h3>

  <div class="w3-container w3-display-container">
    <form id="add_bid" action="add_bid.php" method="post">
      <div class="row">
        <div class="col s4">
          <p><label><i class="fa fa-dollar"></i> Price (integer):</label></p>
      		<!--<input class="w3-input w3-border datepicker" type="text" placeholder="YYYY/MM/DD" name="startdate" required>-->
          <input class="w3-input w3-border" type="number" placeholder=" Your price here" name="price"/>
        </div>
        <div class="col s4">
          <p><label><i class="fa fa-bidder"></i> Bidder (email):</label></p>
      		<input class="w3-input w3-border" type="text" placeholder=" Your bidder email" name="bidder"/>
        </div>
        <div class="col s4">
          <p><label><i class="fa fa-caretaker"></i> Caretaker (email):</label></p>
          <input class="w3-input w3-border" type="text" placeholder=" Your desired caretaker" name="caretaker"/>
        </div>
      </div>
      <div class="row">
        <div class="col s4">
