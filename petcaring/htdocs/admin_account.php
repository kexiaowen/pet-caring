...
<body>
  <div class="row">
      ...
      <div class="col s2 sidenav">
        ...
        <h5 class="light"><a href="#" class="light-blue-text text-darken-4 light link">Log out</a></h5>
      </div>
      ...
      <div class="col s10 page-content">
        ...
        <table style="width:100%" class="highlight">
          ...
          <?php
            ...
            while($row = pg_fetch_assoc($result)){
              ...
              echo "<tr>";
                ...
                <div class = 'delete' >
                  <td align='center'>
                    <form name='edit' action='admin_account.php'  method='POST'>
                      <input type='hidden' name='name' value='$name'>
                      <input type='hidden' name='email' value='$email'>
                      <input type='hidden' name='password' value='$password'>
                      <input type='hidden' name='region' value='$region'>
                      ...
                      <button href='#' type='submit' name='delete' class='btn waves-effect waves-light red'>Delete</button>
                    </form>
                  </td>
                </div>";*/
          ...
          <!--<a type='submit' name='delete' value='delete'>Delete</a>-->
        </table>
      </div>
